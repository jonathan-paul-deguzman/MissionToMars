...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        ArrayList<Item> phaseOneItems = phaseOneSimulation.loadItems(new File("space_challenge_phase_1.txt"));
        ...
        System.out.printf("PHASE 1: The total budget for using main.java.Models.U1 rockets is: $%d\n", phaseOneTotalBudgetForU1Rockets);
        System.out.printf("PHASE 1: The total budget for using main.java.Models.U2 rockets is: $%d\n", phaseOneTotalBudgetForU2Rockets);

        Simulation phaseTwoSimulation = new Simulation();
        ArrayList<Item> phaseTwoItems = phaseTwoSimulation.loadItems(new File("space_challenge_phase_2.txt"));
        ...
        System.out.printf("PHASE 2: The total budget for using main.java.Models.U1 rockets is: $%d\n", phaseTwoTotalBudgetForU1Rockets);
        System.out.printf("PHASE 2: The total budget for using main.java.Models.U2 rockets is: $%d\n", phaseTwoTotalBudgetForU2Rockets);

        String phaseOneBestRocket = (phaseOneTotalBudgetForU1Rockets < phaseOneTotalBudgetForU2Rockets) ? "main.java.Models.U1" : "main.java.Models.U2";
        String phaseTwoBestRocket = (phaseTwoTotalBudgetForU1Rockets < phaseTwoTotalBudgetForU2Rockets) ? "main.java.Models.U1" : "main.java.Models.U2";
        System.out.println("\nJourney Plan:");
